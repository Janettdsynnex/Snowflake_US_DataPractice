...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCHONN",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as LAST_CHANGED_ON
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDSERVDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as SERVICES_RENDERED_DATE
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDTRANSE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) AS CONVERSION_DATE
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDPRICEE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as PRICING_EXCHANGE_RATE_DATE
...
END AS STATS_DATE
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDSTATDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as STATS_DATE
--,CASE
 -- WHEN t1."/BIC/TUDSTUPDE" IS NULL OR t1."/BIC/TUDSTUPDE" = '' OR t1."/BIC/TUDSTUPDE" = '00000000'  THEN NULL
  --ELSE TO_DATE(TO_CHAR(TO_DATE(t1."/BIC/TUDSTATDE", 'YYYYMMDD'), 'YYYY-MM-DD'))
--END 
--,NULL AS UPDATE_DATE_STATS
,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDSTUPDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as UPDATE_DATE_STATS
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDZZDATE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as END_USER_DATE
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDREQDAE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as REQ_DELIVERY_DATE
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCREATN",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as CREATION_DATE
-- ,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDLOADAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as LOADING_DATE_INTO_BW
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDOERDAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as SALES_ORDER_DATE
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDARCHH",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as ARCHIVING_DATE
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDPRCSOO",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as PRICING_DATE_SO 
...
,CASE
  ...
  END AS COND_DATE
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCODTT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as COND_DATE
...
END AS COND_DATE_SO
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCODTSO",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as COND_DATE_SO
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDORGDAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as ORIGINAL_BILL_DATE
...
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDPOSRDT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) as POS_REPORTING_DATE
...
END AS SALES_ORDER_DATE
--,TO_DATE(TO_CHAR(TO_DATE(NULLIF(t68_1."/BIC/TNSOCRDAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD')) AS SALES_ORDER_DATE
,NULL AS WARRANTY 
...
,CASE
  ...
  --ELSE TO_DATE(t68_1.calday, 'YYYYMMDD')
END AS CALENDAR_DATE
...
, to_char(inv.fx_net_u_price) as NSP_EUR
, NULL as SND_VENDOR_ALLOW_DC
, NULL as SND_VENDOR_ALLOW_LC
, NULL as PC_PRICE
, NULL as PC_PRICE_LC
