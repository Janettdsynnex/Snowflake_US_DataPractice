...
select 
md5(concat('', '', '', '', t1."/BIC/TUCBILLNM", t1."/BIC/TUCBILLIM", t1.SOURSYSTEM, t1.RECORDMODE)) as pkey_billing
,md5(t1."/BIC/TUCPROFIR") as fkey_tucprofir_master
...
,t1."/BIC/TUDSERVDE" as SERVICES_RENDERED_DATE
,t1."/BIC/TUCSALESL" as SALES_DEAL
,t1."/BIC/TUDTRANSE" as CONVERSION_DATE
...
,t1."/BIC/TUDPRICEE" as PRICING_EXCHANGE_RATE_DATE
,t1."/BIC/TUCITEMCG" as SALES_DOC_ITEM_CAT
,t1."/BIC/TUCSALESY" as SALES_EMPLOYEE
,t1."/BIC/TUDSTATDE" as STATS_DATE
,t1."/BIC/TUDSTUPDE" as UPDATE_DATE_STATS
...
,t1."/BIC/TUDZZDATE" as END_USER_DATE
...
,t1."/BIC/TUKNETVAV" as NET_VALUE_BILL_ITEM
...
,t1."/BIC/TUDREQDAE" as REQ_DELIVERY_DATE
...
,t1."/BIC/TUCKONDM" as MATERIAL_PRICING_GR
...
,t1."/BIC/TUDLOADAT" as LOADING_DATE_INTO_BW
...
,t1."/BIC/TUCADRSO" as SOLD_TO_PARTY_DETAI
...
,t1."/BIC/TUDARCHH" as ARCHIVING_DATE
,t1."/BIC/TUKSB44SO" as PC_PRICE_VENDOR_CUR_SO
,t1."/BIC/TUDPRCSOO" as PRICING_DATE_SO 
...
,t1."/BIC/TUCZOA1" as CUSTOM_FLA
,t1."/BIC/TUKZOR1V" as CUSTOME_VALUE_LC
,t1."/BIC/TUYOYCURR" as ROYALTY_CUR
,t1."/BIC/TUDORGDAT" as ORIGINAL_BILL_DATE
...
,t1."/BIC/TUDPOSRDT" as POS_REPORTING_DATE
...
,t1."/BIC/TUCTCDAYS" as CALENDAR_DATE
...
-- part 2 SAP 6.8
  select 
md5(concat("/BIC/TNCBITEM", "/BIC/TNCBNUM", "/BIC/TNCBLGNUM", "/BIC/TNCBLGTYP", "/BIC/TNBILL_NM", BILL_ITEM, t68_1.SOURSYSTEM, '')) as pkey_billing
,md5("/BIC/TNPROFITC") as fkey_tecprofir_master
...
,NULL AS END_USER_DETAIL_INFO
,NULL AS SHIP_TO_DETAIL_INFO
...
,t68_1."/BIC/TNSOCRDAT" AS SALES_ORDER_DATE
,NULL AS WARRANTY 
...
,NULL AS FISCAL_YEAR_QUARTER
,t68_1."/BIC/AACALDAY" AS BILL_DATE
,NULL AS CALENDAR_YEAR_WEEK
,NULL AS CALENDAR_DAY
,NULL AS FISCAL_YEAR_PERIOD
,t68_1.CALMONTH AS CALENDAR_YEAR_MONTH
,NULL AS CALENDAR_MONTH_2
...
, NULL as FUNCTIONAL_DISCOUNT
, NULL as FUNCTIONAL_DISCOUNT_LC
, to_char(matl.entry_datetime) as SALES_ORDER_DATE
, NULL as WARRANTY
, NULL as EDI_ENDCUST_INVOICE
, NULL as UTC_TIME_STAMP
, NULL as SOLD_TO_PARTY_DETAIL
