...
cis_cust_xref as (
        ...
        -- ANALYTICS.EDW_CIS_US.DIM_PUB_CUSTOMER_INFO_VIEW_US cust
...
--,md5(concat(t1.SOURSYSTEM, t1."/BIC/TUCSALESG", t1."/BIC/TUCCOMPCE", t1."/BIC/TUCDIVISN", t1."/BIC/TUCDISTRN", t1."/BIC/TUCSOLDTO")) as fkey_customer_master
...
,md5(concat(t1.SOURSYSTEM,t1."/BIC/TUCMATERL", 'US01', t1."/BIC/TUCDISTRN")) as MATERIAL_MASTER_KEY
,t1."/BIC/TUCSOLDTO" as RESELLER_ID_46
--,t1."/BIC/TUCSOLDTO" as RESELLER_ID_COMBINED
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCHONN",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as LAST_CHANGED_ON
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDSERVDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as SERVICES_RENDERED_DATE
,t1."/BIC/TUCSALESL" as SALES_DEAL
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDTRANSE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') AS CONVERSION_DATE
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDPRICEE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as PRICING_EXCHANGE_RATE_DATE
,t1."/BIC/TUCITEMCG" as SALES_DOC_ITEM_CAT
,t1."/BIC/TUCSALESY" as SALES_EMPLOYEE
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDSTATDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as STATS_DATE
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDSTUPDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as UPDATE_DATE_STATS
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDZZDATE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as END_USER_DATE
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDREQDAE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as REQ_DELIVERY_DATE
...
,t1."/BIC/TUCCOMPCE" as COMPANY_CODE
,t1."/BIC/TUCSALESG" as SALES_ORG
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCREATN",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as CREATION_DATE
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDLOADAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as LOADING_DATE_INTO_BW
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDOERDAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as SALES_ORDER_DATE
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDARCHH",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as ARCHIVING_DATE
,t1."/BIC/TUKSB44SO" as PC_PRICE_VENDOR_CUR_SO 
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDPRCSOO",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as PRICING_DATE_SO 
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCODTT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as COND_DATE
,t1."/BIC/TUKSB87" as COPY_RIGHT_TAX_ZZG9
,t1."/BIC/TUKSB87L" as COPY_RIGHT_TAX_ZZG9_LC
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDCODTSO",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as COND_DATE_SO
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDORGDAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as ORIGINAL_BILL_DATE
...
,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDPOSRDT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as POS_REPORTING_DATE
...
,CASE
  WHEN t1."/BIC/TUCTCDAYS" IS NULL OR t1."/BIC/TUCTCDAYS" = '' THEN NULL
  ELSE TO_CHAR(TO_DATE(t1."/BIC/TUCTCDAYS", 'YYYYMMDD'), 'YYYY-MM-DD')
END AS CALENDAR_DATE
--,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUCTCDAYS",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as CALENDAR_DATE
,t1.FISCVARNT as FISCAL_YEAR_VARIANT 
,t1."/BIC/TUCFISQUA" as FISCAL_YEAR_QUARTER
,CASE
  WHEN t1."/BIC/TUDBILLDE" IS NULL OR t1."/BIC/TUDBILLDE" = '' THEN NULL
  ELSE TO_CHAR(TO_DATE(t1."/BIC/TUDBILLDE", 'YYYYMMDD'), 'YYYY-MM-DD')
END AS BILL_DATE
--,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDBILLDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as BILL_DATE
,t1.CALWEEK as CALENDAR_YEAR_WEEK
,CASE
  WHEN calday IS NULL OR calday = '' THEN NULL
  ELSE TO_CHAR(TO_DATE(t1."/BIC/TUDBILLDE", 'YYYYMMDD'), 'YYYY-MM-DD')
END AS CALENDAR_DAY
--,TO_CHAR(TO_DATE(NULLIF(calday,'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as CALENDAR_DAY
...
--,TO_CHAR(TO_DATE(NULLIF(t1."/BIC/TUDBILLDE",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as BILL_DOC_DATE
,NULL AS LOADING_DATE
, t7."/BIC/TUCNAMEE" as CUST_NAME 
, t7."/BIC/TUCACCNTP" as ACCNT_TYPE

-- ,CASE 
--                WHEN (t7."/BIC/TUCKONZS" LIKE '%[Aa-Zz ]%' 
--                  OR t7."/BIC/TUCKONZS" = '' 
--                  OR t7."/BIC/TUCKONZS" IS NULL 
--                  OR t7."/BIC/TUCKONZS" = '0000000000')
--     THEN t7."/BIC/TUCCUSTOR" 
--                ELSE t7."/BIC/TUCKONZS" 
-- END AS GROUPKEY 
...
-- ,md5(concat(t68_1.SOURSYSTEM, t68_1."/BIC/TNSALEORG", t68_1."/BIC/TNSALEORG", '00', '01', "/BIC/TNSOLDTO")) as fkey_customer_master
-- ,md5(concat(t68_1.SOURSYSTEM,t68_1."/BIC/TNMATERIL", t68_1."/BIC/TNSALEORG", '01')) as fkey_material_master
,md5(concat(t68_1.SOURSYSTEM, 'US01', 'US01', '00', '01', "/BIC/TNSOLDTO")) as CUSTOMER_MASTER_KEY
,md5(concat(t68_1.SOURSYSTEM,t68_1."/BIC/TNMATERIL", 'US01', '01')) as MATERIAL_MASTER_KEY
,t68_3.TUCCUSTOR_46 as RESELLER_ID_46

-- ,case 
--     when t68_3.TUCCUSTOR_46 is not null then t68_3.TUCCUSTOR_46 
--     else t68_1."/BIC/TNSOLDTO"
--  end as RESELLER_ID_COMBINED
,NVL(cis_cust_xref.cust_no, NVL(t68_3."TUCCUSTOR_46", t68_1."/BIC/TNSOLDTO")) as RESELLER_ID_COMBINED    
...
,NULL AS SELL_PRICE_LC
,NULL AS SYSTEM_SELL_PRICE_LC
,NULL AS PROPOSED_FREIGHT_LC
,NULL AS ACTUAL_FREIGHT_LC
,NULL AS FRONT_END_PROFIT_LC
,NULL AS NET_SALES_PROFIT_LC
,NULL AS NET_VALUE_LC
,NULL AS COST_LC
,NULL AS SELL_PRICE_EUR
,NULL AS SYSTEM_SELL_PRICE_EUR
,NULL AS PROPOSED_FREIGHT_EUR
,NULL AS ACTUAL_FREIGHT_EUR
,NULL AS FRONT_END_PROFIT_EUR
,t68_1."/BIC/TNZZA22" AS NET_SALES_PROFIT_EUR
,NULL AS COST_EUR 
,NULL AS SHIPPING_TYPE
,NULL AS DIVISION
,'00' AS TUCDIVISN
,t68_1."/BIC/TNSALEORG" AS COMPANY_CODE
,t68_1."/BIC/TNSALEORG" AS SALES_ORG
,'01' AS DISTR_CHANNEL
...
,TO_varchar(TO_DATE(NULLIF(t68_1."/BIC/TNSOCRDAT",'00000000'),'YYYYMMDD'),'YYYY-MM-DD') AS SALES_ORDER_DATE
,NULL AS WARRANTY 
...
,NULL AS SBU_HRCHY_L1_OLD 
,CASE
  WHEN t68_1.calday IS NULL OR t68_1.calday = '' THEN NULL
  ELSE TO_CHAR(TO_DATE(t68_1.calday, 'YYYYMMDD'), 'YYYY-MM-DD')
END AS CALENDAR_DATE
--,TO_CHAR(TO_DATE(NULLIF(t68_1.calday,'00000000'),'YYYYMMDD'),'YYYY-MM-DD') AS CALENDAR_DATE
,NULL AS FISCAL_YEAR_VARIANT 
,t68_1."/BIC/NFSCQTR2" AS FISCAL_YEAR_QUARTER
,CASE
  WHEN t68_1.bill_date IS NULL OR t68_1.bill_date = '' THEN NULL
  ELSE TO_CHAR(TO_DATE(t68_1.bill_date, 'YYYYMMDD'), 'YYYY-MM-DD')
END AS BILL_DATE
--,TO_CHAR(TO_DATE(NULLIF(t68_1.bill_date,'00000000'),'YYYYMMDD'),'YYYY-MM-DD') as BILL_DATE 
,t68_1.calweek AS CALENDAR_YEAR_WEEK
,CASE
  WHEN t68_1.calday IS NULL OR t68_1.calday = '' THEN NULL
  ELSE TO_CHAR(TO_DATE(t68_1.calday, 'YYYYMMDD'), 'YYYY-MM-DD')
END AS CALENDAR_DAY
--,TO_CHAR(TO_DATE(NULLIF(t68_1.calday,'00000000'),'YYYYMMDD'),'YYYY-MM-DD') AS CALENDAR_DAY
...
,CASE
  ...
  ELSE TO_CHAR(TO_DATE(t68_1.bill_date, 'YYYYMMDD'), 'YYYY-MM-DD')
END AS BILL_DOC_DATE
--,TO_CHAR(TO_DATE(NULLIF(t68_1.bill_date,'00000000'),'YYYYMMDD'),'YYYY-MM-DD') AS BILL_DOC_DATE
,NULL AS LOADING_DATE  
...
,SYSDATE() as UPDATE_DATE_UTC 
 ...
 left join {{ ref('customermaster_base_68_mapped') }}  as t68_3 
...
,md5(concat('CIS_US', to_char(inv.cust_no))) as fkey_customer
,md5(concat('CIS_US', to_char(matl.sku_no))) as fkey_material
...
, NULL as PROPOSED_FREIGHT_LC
, NULL as ACTUAL_FREIGHT_LC
, to_char(inv.u_price-inv.u_cost) as FRONT_END_PROFIT_LC
, NULL as NET_SALES_PROFIT_LC
, NULL as NET_VALUE_LC
...
, NULL as FUNCTIONAL_DISCOUNT
, NULL as FUNCTIONAL_DISCOUNT_LC
, to_date(matl.entry_datetime) as SALES_ORDER_DATE
, NULL as WARRANTY
, NULL as EDI_ENDCUST_INVOICE
, NULL as UTC_TIME_STAMP
, NULL as SOLD_TO_PARTY_DETAIL
...
, NULL as BTO_CUM_VALUE_LC 
, NULL as SBU_HRCHY_L1_OLD
,To_char(inv.date_flag,'YYYYMMDD') as CALENDAR_DATE 
, NULL as FISCAL_YEAR_VARIANT 
, dt."/BIC/TUCFQYR" as fiscal_year_quarter
, To_char(inv.date_flag,'YYYYMMDD') as BILL_DATE
, concat(year(to_date(inv.date_flag)),week(to_date(inv.date_flag))) as calendar_year_week 
, To_char(inv.date_flag,'YYYYMMDD') as CALENDAR_DAY
...
, To_char(inv.date_flag,'YYYYMMDD') as BILL_DOC_DATE
, NULL as LOADING_DATE
