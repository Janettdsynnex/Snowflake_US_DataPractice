...
with t6 as (select distinct t1."/BIC/TUCMATERL"
            --from ANALYTICS.EDW_SAP_BW_US_46.TUCMATERL  as t1 
            --left join ANALYTICS.EDW_SAP_BW_US_46.TUCMATSAS  as t3 
...
--join  ANALYTICS.EDW_SAP_BW_US_68.TNMATSLS t4
...
, NULL as LAST_CHANGED_ON_SS
, NULL as CONFORMITY_VALID_FROM
, TO_DATE(matl.ENTRY_DATETIME) as CREATION_DATE_SS
, NULL as DND_EXPIRY_DATE
, NULL as LAST_SO_DATE
, NULL as PL_ACTIVE_VALID_FROM_HRZN
, NULL as DISTR_CHAIN_VALIDITY_DATE
...
select 
md5(concat('CIS_CA', sku_no)) as pkey_material
...
from {{source('ca_cdp_cis_ca','DM_PUB_PART_INFO_VIEW_CA') }} matl
left join {{ source('ca_cdp_cis_ca', 'DM_PUB_VENDOR_INFO_VIEW_CA')}} vend
--from ANALYTICS.EDW_CIS_CA.DM_PUB_PART_INFO_VIEW_CA matl
--left join ANALYTICS.EDW_CIS_CA.DM_PUB_VENDOR_INFO_VIEW_CA vend
  on matl.vend_no = vend.vend_no
