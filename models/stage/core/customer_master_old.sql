...
select
md5(concat('CIS_US', to_char(CUST.CUST_NO))) as pkey_customer
, 'CIS_US' as SOURSYSTEM
, to_char(CUST.DIVISION) as SALES_ORG
, 'CIS_US' as COMPANY_CODE
, NULL as DIVISION
, 0 as DISTR_CHANNEL
, to_char(CUST.CUST_NO) as RESELLER_ID
, to_char(CUST.CUST_NO) as RESELLER_ID_46
, to_char(CUST.CUST_NO) as RESELLER_ID_COMBINED
, NULL as RESELLER_ID_68
, cust.IS_DISCONTINUED as ACCOUNT_CLOSURE_FLAG
, cust.IS_DISCONTINUED as DELETION_FLAG_MAIN
, NULL as LAST_PACE_FLAG
, NULL as PACE_FLAG_UPDATE
, NULL as LAST_PACE_CLUSTER
, NULL as LAST_CE_SEGMENT_TEXT
...
, cust.BILL_TO_CUST_CITY as CITY
, NULL as COUNTRY_KEY
, NULL as CUST_CLASSIFICATION
, NULL as COUNTY_CODE
, NULL as CUSTOMER_IS_CONSUMER
, cust.IS_DISCONTINUED as DELETION_FLAG
, NULL as DUNS_NBR
, NULL as FAX_NBR
, NULL as INDUSTRY_KEY
, NULL as INDUSTRY_KEY_TEXT
, NULL as INDUSTRY_CODE_1
, NULL as INDUSTRY_CODE_2
, NULL as INDUSTRY_CODE_3
, NULL as INDUSTRY_CODE_4
, NULL as INDUSTRY_CODE_5
, NULL as LANGUAGE_KEY
, cust.MCUST_NAME as RESELLER_NAME
, NULL as NAME_2
, NULL as NAME_3
, NULL as NIELSEN_ID
, NULL as TRADING_PARTNER
, cust.BILL_TO_CONTACT_PHONE as FIRST_TELEPHONE_NBR
, NULL as PLANT
, NULL as PO_BOX
, cust.BILL_TO_CUST_ZIP as POSTAL_CODE
, NULL as CAM_PO_BOX
, NULL as CAM_POSTAL_CODE_GEO
, NULL as REGION
, cust.BILL_TO_CUST_ADDR as HOUSE_NBR_AND_STR
, NULL as SORT_FIELD
, NULL as TAX_NBR_1
, NULL as TAX_NBR_2
...
, NULL as INTL_LOCATION_NBR_2
, NULL as CHECK_DIGIT_INTL_LOC
, cust.BILL_TO_CONTACT_EMAIL as CUST_EMAIL_ADDRESS
, xref.ENTRY_DATETIME as CREATION_DATE
, NULL as BILL_BLOCK
, NULL as LEGAL_STATUS
, NULL as ASGMT_TO_HRCHY
, NULL as DELIVERY_WAVER
...
, NULL as ACCNT_NBR_DUN_RECIP
, NULL as CREDIT_CONTROL_AREA_CC
, cust.IS_DISCONTINUED as DELETION_FLAG_CC
, NULL as EMPLOYEE
, cust.DEFAULT_TERMS as PAYMENT_TERMS_CC
, NULL as PAYMENT_BLOCK_KEY
...
, NULL as LAST_GEN_INFO
, NULL as CURRENCY_KEY_AMNT_INS
, cust.CURRENCY as CURRENCY_KEY_CC
, NULL as RECONCILIATION_ACCNT
, NULL as CHART_OF_ACCNTS
, NULL as CUST_ACCNT_NBR_CL_REF
, NULL as CASH_MGMT_GRP
...
, NULL as ORDER_FULFILLMENT
, NULL as CREDIT_CONTROL_AREA_SS
, cust.IS_DISCONTINUED as DELETION_FLAG_SS
, NULL as INCOTERMS_PART_1
, NULL as INCOTERMS_PART_2
, NULL as PLANT_SS
, cust.DEFAULT_TERMS as PAYMENT_TERMS_SS
, NULL as SALES_DISTRICT
, NULL as SALES_GRP
, NULL as SALES_OFFICE
, cust.IS_DISCONTINUED as ACTIVITY_FLAG
, NULL as ORDER_BLOCK_SS
, NULL as CUST_CLASS_ENTERPRISE
, NULL as CUST_RECEIVE_REBATES
, NULL as EDI_CUST_GRP
...
, NULL as CUST_UNWILLING
, SYSDATE() as UPDATE_DATE_UTC
from {{ source('us_cdp_cis_us','DIM_PUB_CUSTOMER_INFO_VIEW_US') }}  cust
left join {{ source('us_cdp_cis_us','DIM_PUB_CUSTOMER_ADDRESS_CONTACTS_INFO_US') }}  addr
 on cust.cust_no = addr.cust_no
  and addr.xref_seq = '1'
left join {{ source('us_cdp_cis_us','DIM_PUB_SALES_HIERARCHY_BY_TERR_USER_ROLE_VIEW_US') }}  terr
  on cust.sales_terr = to_char(terr.sales_terr)
  and user_role = 'Rep' 
  and is_primary = 'Y'
  and user_end_date is null
left join {{ source('us_cdp_cis_us','DIM_PUB_CUSTOMER_XREF_US') }} xref
