...
inner join {{ source('us_cdp_bw_46','TUCDOCTYX') }}  as t2 
   on t1."/BIC/TUCDOCTYX" = t2."/BIC/TUCDOCTYX"
  and t2."/BIC/TUCDOCTP1" in ('1','2','5')
  
inner join {{ source('us_cdp_bw_46','TUCCUSTSS') }} as t3 
